      ...
      <section className="p-8">
        <div className="max-w-md mx-auto">
          ...
          <div className="mt-8 p-4 bg-primary/5 rounded-lg">
            ...
            <p className="text-xs text-primary/50">Admin: admin@handcraftedhaven.com / admin123</p>
            <p className="text-xs text-primary/50">Seller: jane@example.com / seller123</p>
            <p className="text-xs text-primary/50">Buyer: john@example.com / buyer123</p>
          </div>
        </div>
      </section>
    </main>
